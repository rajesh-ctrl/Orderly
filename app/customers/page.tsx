  ...
  if (!orgId) {
    return (
      <div className="pl-9 pb-20">
        ...
        <p>Switch to an organisation to view customers.</p>
        <div className="mt-4">
          <Link
    ...
    <div className="pl-9 pb-20">
        ...
        <div className="w-[90%] mx-auto mt-2 mb-3">
          <div className="flex flex-wrap items-start gap-3 justify-between">
            ...
            <form
              action="/customers"
              method="GET"
              className="flex-1 min-w-[280px] flex items-end gap-2"
            >
              <label className="flex flex-col gap-1 w-full">
                ...
                <input
                  ...
                  name="q"
                  defaultValue={q}
                  placeholder="Name, tax number, email, phone"
      ...
      {params.delete === "true" && (
        <div className="mb-4 mt-2 bg-red-100 text-red-800 px-4 py-2 rounded w-[90%] mx-auto">
          🗑️ Customer deleted successfully!
        </div>
      )}
