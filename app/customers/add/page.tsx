...
export default async function AddCustomerPage({
  ...
  return (
    <div className="p-4 md:p-6 w-full md:pl-20 pt-8">
      <h1 className="text-xl md:text-2xl font-bold mb-2">Add Customer</h1>
      <h3 className="text-sm md:text-base font-light mb-1">
        Register a new customer to the current organisation
      </h3>
      ...
      >
        ...
        <p className="text-gray-600 text-sm italic">
          Make sure the customer is not already available!
        </p>
      </form>
    </div>
  );
